...
SnapSerializer.prototype.rawLoadProjectModel = function (xmlNode) {
    ...
    project.uuid = model.project.attributes.uuid;
...
SnapSerializer.prototype.loadCustomBlocks = function (
    ...
    var myself = this;
    element.children.forEach(function (child) {
        var definition, names, inputs, vars, header, code, trans, comment, password, salt, i;
